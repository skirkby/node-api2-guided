...
// words, server.all('/api/hubs', (req, res, next) => {...}) acts like there was
// a call to server.get('/api/hubs', (req, res, next) => {...}), and a call to
// server.post('/api/hubs', (req, res, next) => {...}), and so on. 
// 
